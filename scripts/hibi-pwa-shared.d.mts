...
export declare function hibiPwaHeadTags(appName?: string): Array<[string, string]>;
export declare const GROK_EXTENSIONS_SCRIPT_SRC: string;
export declare function readHibiProjectId(): string;
export declare function readXCreator(): string;
export declare function readXCreatorId(): string;
export declare function hibiXCreatorHeadTags(creator?: string, creatorId?: string): string[];
export declare function hibiExtensionsHeadTags(projectId?: string): string[];
...
export declare function hibiOgHeadTags(ctx?: {
  host?: string;
  appName?: string;
  site?: OgSite;
  documentTitle?: string;
...
export declare function normalizeHeadContext(ctx?: HibiHeadContext): {
  appName: string;
  projectId: string;
  creator: string;
  creatorId: string;
...
export declare function injectHibiPwaHead(html: string, ctx?: HibiHeadContext): string;
export declare function createHeadInjector(ctx?: HibiHeadContext): {
