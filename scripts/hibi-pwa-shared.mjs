...
export function hibiPwaHeadTags(appName = DEFAULT_APP_NAME) {
  return [
...
export function readHibiProjectId() {
...
export function hibiXCreatorHeadTags(creator = readXCreator(), creatorId = readXCreatorId()) {
...
export function hibiExtensionsHeadTags(projectId = readHibiProjectId()) {
...
export function hibiOgHeadTags({
  host = "",
  appName = DEFAULT_APP_NAME,
  site = {},
  documentTitle = "",
...
export function normalizeHeadContext(ctx = {}) {
  ...
  return {
    appName,
    projectId: ctx.projectId ?? readHibiProjectId(),
...
export function injectHibiPwaHead(html, ctx = {}) {
  ...
  next = insertAfterHeadOpen(
    next,
    hibiOgHeadTags({ host, appName, site, documentTitle, cwd }).join(""),
  );

  if (!next.includes("/grok-app-builder/extensions.js")) {
    missing.push(...hibiExtensionsHeadTags(projectId));
  ...
  const creatorTags = hibiXCreatorHeadTags(creator, creatorId);
